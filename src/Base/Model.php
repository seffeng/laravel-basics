 ...
 * @method static \Illuminate\Pagination\LengthAwarePaginator paginate(int|null $perPage = null, array $columns = ['*'], string $pageName = 'page', int|null $page = null)
 * @method static \Illuminate\Pagination\Paginator cursorPaginate($perPage = null, $columns = ['*'], $cursorName = 'cursor', $cursor = null)
 * @method static \Illuminate\Pagination\Paginator simplePaginate($perPage = null, $columns = ['*'], $pageName = 'page', $page = null)
 ...
 * @method static Model select(array|mixed $columns = ['*'])
 * @method static Model leftJoin($table, $first, $operator = null, $second = null)
 * @method static \Illuminate\Support\Collection pluck(string $column, string $key = null)
 * @method static integer count(string $columns = '*')
